...
public class JavaHttpClient {
    ...
    public ResultBotTelegramList buscarAtualizacao() {
        ...
        try {
            // pega a resposta e transforma no objeto ResultBotTelegramList por meio do objectMapper
    ...
    public ResultBotTelegram enviarMensagem(MessageSend msg) {
        ...
        try {
            // transforma o objeto recebido "MessageSend" em um JSON
        ...
        try {
            // transforma a resposta recebida em JSON no objeto ResultBotTelegram
